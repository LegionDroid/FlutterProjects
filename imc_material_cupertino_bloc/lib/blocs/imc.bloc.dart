...
class ImcBloc {
  var heigtCtrl = new MaskedTextController(mask: "000");
  var weigtCtrl = new MaskedTextController(mask: "000");
  var result = "Preencha seus dados para calcular o IMC";

  calculate() {
    double weight = double.parse(weigtCtrl.text);
    double height = double.parse(heigtCtrl.text) / 100;
